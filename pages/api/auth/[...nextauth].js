...
const options = {
  ...
  providers: [
    ...
    Providers.Google({
      clientId: "226949477605-1iooeuhhfetbsk65vaj9dif8sk2nck7b.apps.googleusercontent.com",
      clientSecret: "FWLZPCacnXIVkTciUmSJGsGm",
    }),
    Providers.Facebook({
  ...
  database: "mongodb://localhost:27017/wiki-ev",
